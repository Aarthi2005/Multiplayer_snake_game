...
with open(r"C:\Users\aarth\OneDrive\Desktop\SEM 5\CN\multiplayer-snake\multiplayer-snake\client\preferences.json") as f:
    SETTINGS = json.load(f)

with open(r"C:\Users\aarth\OneDrive\Desktop\SEM 5\CN\multiplayer-snake\multiplayer-snake\client\screen_sizes.json") as f:
    SIZES = json.load(f)
...
class Game:
    def __init__(self, surface):
        ...
        self.your_board_text = gui_text.Text("You:", FONT, (255, 255, 255), (60, PLAYER_OFFSET // 2))
        self.opponent_board_text = gui_text.Text("Opponent :", FONT, (255, 0, 0), (70, OPPONENT_OFFSET - 30))
        self.score_text = gui_text.Text("Score: 1", FONT, (255, 255, 255), (WIDTH - 70, PLAYER_OFFSET // 2))
        self.opponent_score_text = gui_text.Text("Score: 1", FONT, (255, 0, 0),
    ...
    def run(self) -> None:
        ...
        while True:
            ...
            if self.snake.won(self.apple_goal):
                ...
                self.show_end_screen(f"You won with score:{len(self.snake.coords)}", (0, 255, 0))
                break

            elif self.snake.lost(self.board_size):
                send("lost", client_socket)
                self.show_end_screen(f"You lost!!Try again", (255, 0, 0))
                break
